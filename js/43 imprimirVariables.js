...
document.getElementById("dades").innerHTML =
  "<p>El meu nom és <b>" +
  nom +
  "</b> i el meu cognom és <b>" +
  cognom +
  "</b><br>Tinc <b>" +
  edat +
  "</b> anys.<br>A la pregunta de si tinc mascota o no, la resposta és: <b>" +
  tincMascota +
  "</b></p>";
...
console.log(cotxe);
console.log("El número de cavalls és: " + cotxe.numCavalls);

function sumar(x, y) {
  return x + y;
}

console.log(sumar(25, 42));

function alertBox(missatge) {
  window.alert(missatge);
}

alertBox("Bon divendres tingueu");
let resposta=prompt("Quina és la teva edat?");
